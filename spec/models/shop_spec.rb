...
RSpec.describe Shop, type: :model do
  describe 'Validation test of Shop model' do
    context 'when name is empty' do
      it 'is invalid' do
        shop = Shop.create(name: "", prefecture: "東京都", city: "千代田区",
                          ...
                          business_hour: "27/7", cashless: false, bike_rack: false, remarks: "none")
    ...
    context 'when name length is more than 255' do
      it 'is invalid' do
        shop = Shop.create(name: "ROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFEROADBIKE CAFE",
    ...
    context 'when city length is more than 255' do
      it 'is invalid' do
        shop = Shop.create(name: "ROADBIKE CAFE",prefecture: "東京都",
          city: "千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区千代田区",
          address: "永田町1-7-1", latitude: "35.6758959375736", longitude: "139.74485482624922",
          business_hour: "", cashless: false, bike_rack: false, remarks: "none")
        expect(shop).to be_invalid
      end
    ...
    context 'when address length is more than 255' do
      it 'is invalid' do
        shop = Shop.create(name: "ROADBIKE CAFE",prefecture: "東京都", city: "千代田区",
          address: "永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1永田町1-7-1",
